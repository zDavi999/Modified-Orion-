...
local OrionLib = {
	...
	Themes = {
		Default = {
			Main = Color3.fromRGB(43, 137, 171),
			Second = Color3.fromRGB(109, 247, 245),
			Stroke = Color3.fromRGB(33, 64, 204),
			Divider = Color3.fromRGB(33, 64, 204),
			Text = Color3.fromRGB(13, 21, 79),
			TextDark = Color3.fromRGB(18, 25, 105)
		}
	},
